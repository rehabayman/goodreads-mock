...
function CategoryDetailsDummy(props){
    ...
    let datatoDisplay = props.data.map( book => {
        return (
            ...
            <img src={book.image_path ? process.env.PUBLIC_URL + "/books-covers/" + book.image_path : "/112815953-stock-vector-no-image-available-icon-flat-vector.jpg"} alt="Book Cover" style={{width:"200px", height:"200px"}} />
